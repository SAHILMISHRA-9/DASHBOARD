      ...
      <div className="flex-1 ml-60">
        ...
        <main className="p-6 mt-16 max-w-3xl">
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <Link href="/phc/cases/child" className="px-3 py-2 border rounded">Back</Link>
          </div>

          <p className="text-gray-600 mb-3">Child Immunization Case · ID: {rec.id}</p>
          ...
          <div className="bg-white p-4 rounded shadow mb-4">
            ...
            <textarea className="w-full p-2 border rounded" value={note} onChange={e => setNote(e.target.value)} placeholder="Add note..." />
