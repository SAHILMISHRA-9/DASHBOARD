      ...
      <div className="flex-1 ml-60">
        ...
        <main className="p-6 mt-16">
          ...
          <div className="flex justify-between mb-6">
            <h1 className="text-2xl font-bold">TB Screening</h1>
            <Link href="/phc/cases/tb/new" className="px-3 py-2 bg-blue-600 text-white rounded">
              + New Case
            </Link>
          </div>
            ...
            <div className="space-y-3">
              {list.map(r => (
                <div key={r.id} className="bg-white p-4 rounded shadow flex justify-between">
                  ...
                  <Link href={`/phc/cases/tb/${r.id}`} className="text-blue-600">View</Link>
                </div>
              ))}
            </div>
          )}
