      ...
      <div className="flex-1 ml-60">
        ...
        <main className="p-6 mt-16">
          ...
          <div className="flex justify-between mb-6">
            <h1 className="text-2xl font-bold">NCD Screening</h1>
            <Link href="/phc/cases/ncd/new" className="px-3 py-2 bg-blue-600 text-white rounded">
              + New Case
            </Link>
          </div>
          ...
          <div className="bg-white p-4 rounded shadow mb-5">
            <div className="grid grid-cols-1 md:grid-cols-6 gap-3">
              ...
              <input name="q" value={filters.q} onChange={h}
                placeholder="Search..." className="p-2 border rounded md:col-span-2" />
            ...
            <div className="flex gap-2 mt-3">
              ...
              <button onClick={() => setFilters({ anm_id:"", asha_id:"", area_id:"", risk_level:"", q:"" })}
            ...
            <div className="space-y-3">
              {list.map(r => (
                <div key={r.id} className="bg-white p-4 rounded shadow flex justify-between">
                  ...
                  <Link href={`/phc/cases/ncd/${r.id}`} className="text-blue-600">View</Link>
                </div>
              ))}
            </div>
          )}
