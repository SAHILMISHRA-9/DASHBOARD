...
export default function NewNCD() {
    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 ml-60">
        ...
        <main className="p-6 mt-16 max-w-2xl">
          ...
          <h1 className="text-2xl font-bold mb-4">New NCD Case</h1>
          ...
          <Link href="/phc/cases/ncd" className="ml-3 px-4 py-2 border rounded">Cancel</Link>
